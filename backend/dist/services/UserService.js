...
exports.findUserByName = exports.findUserByEmail = exports.deleteUser = exports.resetUserPassword = exports.updateUserPassword = exports.updateUser = exports.getAllAdmins = exports.getAllUsers = void 0;
...
const getAllAdmins = async () => {
    try {
        const admins = await UserModel_1.default.find({ roles: "admin" }).select("name _id");
        return admins;
    }
    catch (error) {
