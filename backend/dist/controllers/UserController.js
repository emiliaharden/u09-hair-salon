...
exports.deleteUserController = exports.updateUserController = exports.getAllAdminsController = exports.getUsersController = void 0;
...
const getAllAdminsController = async (req, res) => {
    try {
        const admins = await (0, UserService_1.getAllAdmins)();
