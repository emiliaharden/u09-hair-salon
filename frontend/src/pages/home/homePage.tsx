    ...
    return (
        <div className="p-4 text-center mt-10">
            ...
            <p className="text-base md:text-lg text-gray-600 w-full md:w-3/4 mx-auto">
                ...
                well-being. Our skilled hairdressers ensure that every cut and treatment is tailored
                to highlight your unique style and personality.
            </p>
            <br />
            <p className="text-base md:text-lg text-gray-600 w-full md:w-3/4 mx-auto">
                Book your appointment today and let us take care of you with personalized care and
                expertise. With us, every cut and treatment is "cut to perfection" to give you the very
                best.
            </p>
