        ...
        <Layout>
            <div className="p-4 text-center mt-10">
                ...
                <p className="text-lg w-3/4 mx-auto mb-6">
                    We offer a wide range of treatments to help you look and feel your best. From
                    haircuts to color treatments – explore our services and find the perfect option
                    for your needs.
                </p>
                ...
                <div className="w-3/4 mx-auto border rounded-lg p-6 shadow-md">
                    ...
                    <p className="text-lg mt-6">
                        No matter which treatment you choose, you can expect top-quality service and
                        an experience that leaves you feeling satisfied and radiant.
                    </p>
                </div>
            </div>
        </Layout>
